...
DEFAULT_CONTENT = {
    ...
    "commission_box2_text": "If you are interested in purchasing any of my art for prints, send an enquiry with which piece(s) you would like to purchase. You may either buy the just the print or a hand-matted piece with the frame included. The cost will be dependent on the photo, size, and if you want it professionally framed.",
    "svc1_name":     "Weddings",
